...
function update_design(cont) {
	fetch("https://raw.githubusercontent.com/guignome01/placebot/master/design.json", {cache: "no-store"}).then((resp) => {
		if (!resp.ok) {
		...
		if (design.stableVersion != version) {
			...
			notif_sub(`<a href="https://github.com/guignome01/placebot">https://github.com/guignome01/placebot</a>`);
		}
